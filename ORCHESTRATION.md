...
| Host-owned production integration | With `delegation.mcp_catalogs: true`, the host registers a named bundle that a bounded `delegate_task` can request; primary sessions never receive it |
