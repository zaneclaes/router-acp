...
| Host-owned production integration | Host config maps opaque capabilities to registered catalogs; the pre-classifier can attach matching MCPs at first pin, and bounded delegates request capabilities without naming integrations |
